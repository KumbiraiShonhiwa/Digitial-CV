...
const education = [
  {
    ...
    description:
      "Final-year Computer Systems Engineering degree with focus on cybersecurity and IT assurance.",
  },
  {
    ...
    description:
      "Advanced Computer Science studies with specialization in security and systems.",
  },
  {
    ...
    description:
      "Comprehensive computer science education covering all major computing disciplines.",
  },
  {
    ...
    description:
      "Independent Examinations Board certification in advanced academic subjects.",
  },
  {
    ...
    description:
      "International school diploma with advanced mathematics and science studies.",
  },
];
...
const certifications = [
  {
    ...
    status: "In Progress",
    description:
      "Security Operations Center analyst certification covering threat detection and response.",
  },
  {
    ...
    status: "In Progress",
    description:
      "Incident response and cybersecurity certification for handling security incidents.",
  },
];
      ...
      <div className="p-6 bg-background rounded-lg border border-border hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/10">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-space-grotesk font-bold mb-1">
              {degree}
            </h3>
      ...
      <div className="container mx-auto px-4">
        ...
        <div data-animate="fade-in" className="mb-16 max-w-5xl">
          ...
          <p className="text-lg text-foreground/70">
            Academic achievements and professional certifications that
        ...
        {/* Education Timeline */}
        <div className="mb-16">
          <h3 className="text-2xl font-space-grotesk font-bold mb-8">
            Education
          </h3>
